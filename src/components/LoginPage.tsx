    ...
    <div className="h-screen w-screen flex select-none bg-theme-base">
      ...
      >
        ...
        <svg className="absolute inset-0 w-full h-full opacity-[0.07]" aria-hidden="true">
          <defs>
            <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
              <path d="M 40 0 L 0 0 0 40" fill="none" stroke="#5B8DEF" strokeWidth="1" />
            </pattern>
          </defs>
        ...
        <div
          ...
          style={{ background: 'radial-gradient(circle, rgba(91,141,239,0.25) 0%, transparent 70%)' }}
        />
        <div
        ...
        <div className="relative flex items-center gap-2.5">
          <div className="p-2 rounded-lg" style={{ backgroundColor: 'rgba(91,141,239,0.15)' }}>
            <ShieldCheck className="w-6 h-6" style={{ color: '#5B8DEF' }} />
          </div>
          <div>
            <h1 className="font-semibold text-base tracking-wide" style={{ color: '#E6EBF2' }}>Boutinly</h1>
            <span className="text-2xs" style={{ color: '#8B99AE' }}>Enterprise CRM</span>
          </div>
        </div>

        {/* Value proposition */}
        <div className="relative max-w-sm">
          <h2 className="text-2xl font-semibold leading-snug" style={{ color: '#E6EBF2' }}>
            ...
            {[
              ...
              <div key={f.title} className="flex gap-3">
                <span
                  ...
                  style={{ backgroundColor: 'rgba(91,141,239,0.12)', color: '#5B8DEF' }}
                >
                  {f.icon}
                </span>
                <div>
                  <p className="text-sm font-medium" style={{ color: '#E6EBF2' }}>{f.title}</p>
                  <p className="text-xs mt-0.5 leading-relaxed" style={{ color: '#8B99AE' }}>{f.body}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <p className="relative text-2xs" style={{ color: '#8B99AE' }}>
